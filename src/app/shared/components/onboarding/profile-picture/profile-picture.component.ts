...
export class ProfilePictureComponent implements OnInit {
    ...
    public uploadImage() {
        ...
        this.af
            .upload("files-account-images/" + this.path, this.file)
            .then((response) => {
    ...
    public getImagePathStorage() {
        this.af
            .ref("files-account-images/" + this.path)
            .getDownloadURL()
            .subscribe((response) => {
    ...
    public back() {
        this.backTobirthdayEvent.emit({
            backTobirthdayEvent: "backTobirthdayEvent",
        });
    }
}
